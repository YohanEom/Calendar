...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		List<CalendarUser> calendar_users = this.calendarService.getAllUsers();
		model.addAttribute("calendar_users", calendar_users);
		
		List<Event> events = this.calendarService.getAllEvents();
		model.addAttribute("events", events);
		
		List<EventAttendee> eventAttentees = this.calendarService.getAllEventAttendees();
